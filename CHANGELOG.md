...
- Synchronize server version metadata with umbrella/client `0.1.9` release references.
- Set `pyproject.toml` project version to `0.1.9`.

## [0.1.8] - 2026-03-06

### Changed

- Synchronize server version metadata with umbrella/client `0.1.8` release references.
- Set `pyproject.toml` project version to `0.1.8`.

## [0.1.7] - 2026-03-06

### Changed

- Synchronize server version metadata with umbrella/client `0.1.7` release references.
- Set `pyproject.toml` project version to `0.1.7`.
...
[0.1.6]: https://github.com/151henry151/rompmusic-server/releases/tag/v0.1.6
